...
export const wordOrderBank = bank('word-order-exam', [
  q('Reorder: yesterday / I / saw / him', '重组句子', 'I saw him yesterday.', ['I saw him yesterday.','Yesterday I saw him.'], '英语时间状语通常放句首或句末。', ['word-order'], 'basic','reordering'),
  q('Error: Often she goes to school.', '改错语序', 'She often goes to school.', ['She often goes to school.'], '频率副词通常放在行为动词之前。', ['adverb-position'], 'basic','error-correction'),
  q('Reorder: quickly / finished / he / the work', '重组句子', 'He finished the work quickly.', ['He finished the work quickly.'], '副词修饰动词通常放后面。', ['word-order'], 'basic','reordering')
]);
